...
export function EngagementViewChart({ data, queryTime }: EngagementChartProps) {
  ...
  return (
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body p-4">
        <h2 className="card-title text-sm">Recent View Engagement (Past Month)</h2>
        {queryTime !== undefined && (
          ...
          <div className="h-48 min-h-[192px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={engagementData}>
                ...
                <Line type="monotone" dataKey="views" stroke="#8f3f71" dot={false} strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        ) : (
